...
from .data_utils import construct_permute_mnist, construct_split_mnist 
...
from .er_utils import update_reservior, update_fifo_buffer, er_mem_update_hindsight, update_avg_image_vectors
